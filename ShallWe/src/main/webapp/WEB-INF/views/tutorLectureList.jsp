                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                    <h3>10,000원</h3>
                                <div class="heart">
                                    <img src="assets/img/gallery/cancel.png" width="30px" alt="수강취소" title="수강취소">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                    <h3>10,000원</h3>
                                <div class="heart">
                                    <img src="assets/img/gallery/performance.png" width="30px" alt="강사후기등록" title="강사후기등록">
                                </div>
                            </div>
                        </div>
                    </div>
